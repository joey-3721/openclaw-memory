...
- jy's default timezone is **Asia/Shanghai (北京时间, UTC+8)**.
- All scheduling, reminders, weather reports, and time references should use **Beijing time** unless jy explicitly says otherwise.
- jy cares a lot about **US stocks, the US economy, and China economic news**.
